...
void SetupEigenConverters() {
  ...
  EIGEN_MATRIX_CONVERTER(Matrix4cd);
  EIGEN_MATRIX_CONVERTER(Vector2cd);
  EIGEN_MATRIX_CONVERTER(Vector3cd);
  EIGEN_MATRIX_CONVERTER(Vector4cd);
  EIGEN_MATRIX_CONVERTER(RowVector2cd);
  EIGEN_MATRIX_CONVERTER(RowVector3cd);
  EIGEN_MATRIX_CONVERTER(RowVector4cd);

  MAT_CONV(2, 3, stlComplex);
  MAT_CONV(X, 3, stlComplex);
  MAT_CONV(X, X, stlComplex);
  MAT_CONV(X, 1, stlComplex);
  MAT_CONV(1, X, stlComplex);
  MAT_CONV(3, 4, stlComplex);
  MAT_CONV(2, X, stlComplex);
